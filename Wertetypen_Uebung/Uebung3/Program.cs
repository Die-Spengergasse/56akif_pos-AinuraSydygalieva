...
namespace ValueTypes
{
    class TypeExercise
    {
        ...
        {
            return (laenge * breite) ?? 0; // laenge ?? 0 * breite ?? 0
        ...
        {
            return nettopreis * steuerProdukt ?? nettopreis * steuerKategorie ?? nettopreis * (decimal) 1.2; // anstatt (decimal) kann man auch 1.2M verwenden,M=Money
